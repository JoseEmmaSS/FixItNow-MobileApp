...
public class PrincipalEmpresas extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private Fragment solicitudFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_principal_empresas);
...
// Configurar el BottomNavigationView
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.bottom_home:
                        switchFragment(fragmentHome);
                        return true;
                    case R.id.bottom_Solicitud:
                        removeFragmentFromContainer(resultsFragment);
                        switchFragment(solicitudFragment);
                        return true;
    ...
    private void removeFragmentFromContainer(Fragment fragment) {
        if (fragment != null) {
            FragmentManager fragmentManager = getSupportFragmentManager();
            FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.fragmentContainer, emptyFragment); // Usamos emptyFragment aquí
            fragmentTransaction.commit();
        }
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_logout:
                ...
                intent = new Intent(PrincipalEmpresas.this, Empresas.class);

...
public class Empresas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cambiarlogin = findViewById(R.id.usuarios);        // Verifica si el dispositivo tiene el hardware y es compatible con la autenticación biométrica
        ...
        iniciar_sesion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (correo.isEmpty() || contrasena.isEmpty()) {
                    Toast.makeText(Empresas.this, "Please enter email and password.", Toast.LENGTH_SHORT).show();
                } else {
        ...
        recContrasenaTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Empresas.this, Recuperar.class);
        ...
        Cambiarlogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Empresas.this, MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        crearCuentaTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Empresas.this, Registrar.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void validarUsuario(String URL, final String correo, final String contrasena) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Toast.makeText(Empresas.this, "Respuesta: " + response, Toast.LENGTH_SHORT).show();
                ...
                try {
                    ...
                    if (success.equals("true")) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), PrincipalEmpresas.class);
                        startActivity(intent);
                        finish();
                    } else {
                        ...
                        Toast.makeText(Empresas.this, "Error al registrar al usuario", Toast.LENGTH_SHORT).show();
                        // Opcional: Restablecer los campos del formulario
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                    Toast.makeText(Empresas.this, "Error al procesar la respuesta del servidor", Toast.LENGTH_SHORT).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Empresas.this, "Ocurrió un error en la solicitud", Toast.LENGTH_SHORT).show();
            }
        }) {
            @Nullable
            @Override
    ...
    private void showBiometricPrompt() {
        ...
        BiometricPrompt biometricPrompt = new BiometricPrompt(this, executor, new BiometricPrompt.AuthenticationCallback() {
            ...
            public void onAuthenticationError(int errorCode, CharSequence errString) {
                ...
                editor.apply();
                Toast.makeText(Empresas.this, "Error de autenticación otro: " + errString, Toast.LENGTH_SHORT).show();
            ...
            public void onAuthenticationFailed() {
                ...
                Toast.makeText(Empresas.this, "Error se cancelo ", Toast.LENGTH_SHORT).show();
                // Opcional: Restablecer los campos del formulario
            }
        });
